...
/**
 * Runtime structure containing the information about a persistence unit. Two
 * parts of it:
 * 
 * 1) Runtime state This is the state that accumulates as a persistence unit is
 * processed by Gemini JPA. It includes many of the runtime objects that play a
 * role in the persistence unit during its lifecycle and regular use.
 *
 * 2) Descriptor state
 * 
 * This is the configuration state extracted from the persistence descriptor.
 * Note that only the state that is relevant to the runtime is extracted. The
 * rest of the configuration state in the persistence descriptor is ignored.
 * 
 */
...
public class PUnitInfo {
	...
	/**
	 * Info about the persistence descriptor this data came from - set by
	 * bundleUtil
	 * 
	...
	/**
	 * Flag to indicate whether the EMF was set by the Builder or not - set by
	 * EMFServiceProxyHandler or EMFBuilderServiceProxyHandler
	 * 
	 * @see EMFServiceProxyHandler
	 * @see EMFBuilderServiceProxyHandler
	 */
	...
	/**
	 * DataSourceFactory service used to indicate that a data source factory
	 * service was found and can be used - set by ServicesUtil
	 * 
	 * @see ServicesUtil
	 */
	...
	/**
	 * Data source looked up from JNDI. Alternative to the DSF - set by
	 * ServicesUtil
	 * 
	 * @see ServicesUtil
	 */
	...
	/**
	 * Additional properties from a config object - set by the config when
	 * invoked by mgr before registering the punit
	 * 
	...
	/**
	 * The following state is typically set by the XML parser, but may end up
	 * being written by the config if config admin is used
	 * 
	...
	/**
	 * @return the validationJndiName
	 */
	public String getValidationJndiName() {
		return validationJndiName;
	}

	/**
	 * @param validationJndiName
	 *            the validationJndiName to set
	 */
	public void setValidationJndiName(String validationJndiName) {
		this.validationJndiName = validationJndiName;
	}

	/**
	 * @param validationFactory
	 *            the validationFactory to set
	 */
	...
	public ProviderWrapper getAssignedProvider() {
		return assignedProvider;
	}

	public void setAssignedProvider(ProviderWrapper p) {
		this.assignedProvider = p;
	}
	...
	public void setDescriptorInfo(PersistenceDescriptorInfo info) {
	...
	public void setUniquePackageNames(List<String> names) {
		this.uniquePackageNames = names;
	}
	...
	public void setEmfHandler(EMFServiceProxyHandler emfHandler) {
		this.emfHandler = emfHandler;
	}
	...
	public void setEmfService(ServiceRegistration emfService) {
		this.emfService = emfService;
	}

	public EMFBuilderServiceProxyHandler getEmfBuilderHandler() {
		return emfBuilderHandler;
	}

	public void setEmfBuilderHandler(
			EMFBuilderServiceProxyHandler emfBuilderHandler) {
		this.emfBuilderHandler = emfBuilderHandler;
	}

	public ServiceRegistration getEmfBuilderService() {
		return emfBuilderService;
	}

	public void setEmfBuilderService(ServiceRegistration emfBuilderService) {
		this.emfBuilderService = emfBuilderService;
	}
	...
	public boolean isEmfSetByBuilderService() {
		return emfSetByBuilderService;
	}

	public void setEmfSetByBuilderService(boolean flag) {
		emfSetByBuilderService = flag;
	}
	...
	public void setDsfService(ServiceReference dsfService) {
	...
	public ServiceTracker getDsfTracker() {
		return dsfTracker;
	}

	public void setDsfTracker(ServiceTracker dsfTracker) {
		this.dsfTracker = dsfTracker;
	}
	...
	public ServiceRegistration getWeavingHookService() {
		return weavingHookService;
	}

	public void setWeavingHookService(ServiceRegistration weavingHookService) {
		this.weavingHookService = weavingHookService;
	}
	...
	public void setNonJtaDataSource(String s) {
		this.nonJtaDataSource = s;
	}
	...
	public void setJtaDataSource(String s) {
		this.jtaDataSource = s;
	}
	...
	public boolean equals(Object o) {
		return (o instanceof PUnitInfo) && (this.getUnitName() != null)
